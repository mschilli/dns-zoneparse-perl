...
my $str_zonefile = DNS::ZoneParse->new( \$zone_data, 'dns-zoneparse-test.net', \&on_parse_fail );
...
$str_zonefile = DNS::ZoneParse->new( \$serialized, 'dns-zoneparse-test.net', \&on_parse_fail );
...
__DATA__
$TTL 1H
@                       3600   IN      SOA     ns0.dns-zoneparse-test.net.   support\.contact.dns-zoneparse-test.net. (
